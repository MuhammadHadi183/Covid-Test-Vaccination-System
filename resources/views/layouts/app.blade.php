...
<title>{{ $PageTitle ?? 'Apex Immunity Partners' }} — COVID Vaccination System</title>
...
<nav class="topnav">
  <a href="/Dashboard" class="nav-brand" style="text-decoration:none;">
    <img src="{{ asset('uploads/logo.png') }}" alt="Logo" class="brand-icon">
...
<aside class="sidebar">
  ...
  @if($Role === 'admin')
    ...
    <a href="/Admin/Patients" class="nav-item {{ request()->is('Admin/Patients') ? 'active' : '' }}">
    ...
    <a href="/Admin/Vaccines" class="nav-item {{ request()->is('Admin/Vaccines') ? 'active' : '' }}">
    ...
    <a href="/Admin/Security/2FA" class="nav-item {{ request()->is('Admin/Security/2FA*') ? 'active' : '' }}">
    ...
    <a href="/Admin/Hospitals" class="nav-item {{ request()->is('Admin/Hospitals*') ? 'active' : '' }}">
  ...
  @elseif($Role === 'hospital')
    ...
    <a href="/Hospital/Dashboard" class="nav-item {{ request()->is('Hospital/Dashboard') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
      Dashboard
    </a>
    <a href="/Hospital/Patients" class="nav-item {{ request()->is('Hospital/Patients') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      Patient List
    </a>
    <a href="/Hospital/Requests" class="nav-item {{ request()->is('Hospital/Requests') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
      Requests
    </a>
    <a href="/Hospital/Appointments" class="nav-item {{ request()->is('Hospital/Appointments*') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
      Appointments
    </a>
    <a href="/Hospital/Covid-Results" class="nav-item {{ request()->is('Hospital/Covid-Results*') ? 'active' : '' }}">
    ...
    <a href="/Hospital/Vaccinations" class="nav-item {{ request()->is('Hospital/Vaccinations') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
      Vaccinations
    </a>
    <a href="/Hospital/Vaccine-Stock" class="nav-item {{ request()->is('Hospital/Vaccine-Stock*') ? 'active' : '' }}">
    ...
    <a href="/Hospital/Profile" class="nav-item {{ request()->is('Hospital/Profile') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      My Profile
    </a>
  ...
  @elseif($Role === 'patient')
    ...
    <a href="/Patient/Dashboard" class="nav-item {{ request()->is('Patient/Dashboard') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
      Dashboard
    </a>
    <a href="/Patient/Search-Hospitals" class="nav-item {{ request()->is('Patient/Search-Hospitals', 'Patient/Hospitals/*') ? 'active' : '' }}">
    ...
    <a href="/Patient/Book-Appointment" class="nav-item {{ request()->is('Patient/Book-Appointment') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
      Book Appointment
    </a>
    <a href="/Patient/Appointments" class="nav-item {{ request()->is('Patient/Appointments') ? 'active' : '' }}">
    ...
    <a href="/Patient/Requests" class="nav-item {{ request()->is('Patient/Requests') ? 'active' : '' }}">
    ...
    <a href="/Patient/Reports" class="nav-item {{ request()->is('Patient/Reports') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/></svg>
      Reports
    </a>
    <a href="/Patient/Profile" class="nav-item {{ request()->is('Patient/Profile') ? 'active' : '' }}">
      <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
      My Profile
    </a>
  @endif

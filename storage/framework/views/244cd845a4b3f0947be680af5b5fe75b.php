...
<div class="page-header">
  <div>
    ...
    <div class="page-sub"><?php echo e(now()->format('l, d F Y — h:i A')); ?></div>
  </div>
...
<div class="kpi-grid mb-28">
  <div class="kpi-card">
    ...
    <div class="kpi-number"><?php echo e(number_format($TotalPatients)); ?></div>
  ...
  <div class="kpi-card">
    ...
    <div class="kpi-number"><?php echo e(number_format($TotalVaccinated)); ?></div>
  ...
  <div class="kpi-card">
    ...
    <div class="kpi-number"><?php echo e(number_format($PositiveTests)); ?></div>
  ...
  <div class="kpi-card">
    ...
    <div class="kpi-number"><?php echo e(number_format($PendingHospitals)); ?></div>
  ...
  <div class="kpi-card">
    ...
    <div class="kpi-number"><?php echo e(number_format($TotalTests)); ?></div>
  ...
  <div class="kpi-card">
    ...
    <div class="kpi-number"><?php echo e(number_format($TotalHospitals)); ?></div>
  ...
  <div class="card">
    <div class="tbl-wrap">
      <table>
        ...
        <tbody>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($RecentPatients->count() > 0): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $RecentPatients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $P): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td class="td-patient"><strong><?php echo e($P->user->name ?? 'N/A'); ?></strong><span><?php echo e($P->cnic ?? 'No CNIC'); ?></span></td>
  ...
  <div class="card">
    <div class="tbl-wrap">
      <table>
        ...
        <tbody>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($RecentTests->count() > 0): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $RecentTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $T): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td class="td-patient"><strong><?php echo e($T->patient->user->name ?? 'N/A'); ?></strong></td>
              <td style="font-size:.79rem;"><?php echo e($T->test_type); ?></td>
              <td>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($T->result === 'positive'): ?> <span class="badge badge-danger">Positive</span>
                <?php elseif($T->result === 'negative'): ?> <span class="badge badge-success">Negative</span>
                <?php else: ?> <span class="badge badge-warning">Pending</span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              </td>
              <td style="font-size:.82rem;"><?php echo e($T->ct_value ?? 'N/A'); ?></td>
              <td style="font-size:.78rem;"><?php echo e($T->hospital->hospital_name ?? 'N/A'); ?></td>
              <td style="font-size:.77rem;color:var(--text-sub);"><?php echo e($T->created_at->format('d M Y')); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          <?php else: ?>
  ...
  <div class="card card-pad">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($Vaccines->count() > 0): ?>
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 0;border-bottom:1px solid var(--border);">
        <div>
          <div style="font-size:.84rem;font-weight:600;color:var(--primary);"><?php echo e($V->name); ?></div>
          <div style="font-size:.72rem;color:var(--text-sub);"><?php echo e($V->manufacturer); ?> · <?php echo e($V->doses_required); ?> doses</div>
        </div>
        <span class="badge <?php echo e($V->status === 'available' ? 'badge-success' : 'badge-danger'); ?>"><?php echo e(ucfirst($V->status)); ?></span>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aptech\Eprojects\Code\Covid Vacination\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
        ...
        <div class="mb-4 text-sm text-gray-600">
            <?php echo e(__('Please confirm access to your account by entering the authentication code provided to your email address.')); ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.2fa.email.verify')); ?>">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'code','class' => 'block mt-1 w-full','type' => 'text','inputmode' => 'numeric','name' => 'code','autofocus' => true,'autocomplete' => 'one-time-code']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'code','class' => 'block mt-1 w-full','type' => 'text','inputmode' => 'numeric','name' => 'code','autofocus' => true,'autocomplete' => 'one-time-code']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <a href="<?php echo e(route('admin.2fa.email.resend')); ?>" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-4">
...
<?php endif; ?>
<?php /**PATH D:\Aptech\Eprojects\Code\Covid Vacination\resources\views/auth/two-factor-email-challenge.blade.php ENDPATH**/ ?>